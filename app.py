...
OT_PROGRAMS = {
    ...
    "方案七：價值市集": {
        ...
        "cole_steps": (
            ...
            "5. Generalizing: 歸納抉勢代表必須承擔代價，而看清個人核心價值能協助重建生活秩序。\n"
...
st.write("本系統完全整合 **AOTA (美國職能治療學會) OTPF-4 活動分析框架**、**Cole 7 步驟團體帶領架構** 與 **Taylor IRM 關係模式 (Therapeutic Use of Self)** 設計，專為職能治療系學生量身打造的方案設計鷹架系統。")
st.markdown("---")
